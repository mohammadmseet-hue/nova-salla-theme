    ...
    theme   : {
        ...
        extend    : {
            ...
            colors             : {
                ...
                // ── NOVA design system (ported from nova-eyewear-site/src/style.css) ──
                'nova-black'   : '#000000',
                'nova-dark'    : '#0A0A0A',
                'nova-charcoal': '#141414',
                'nova-gray'    : '#1C1C1C',
                'nova-mid'     : '#6B6B6B',
                'nova-light'   : '#A0A0A0',
                'nova-silver'  : '#D4D4D4',
                'nova-white'   : '#FFFFFF',
                'nova-off'     : '#F7F7F7',
                'core'         : '#C8D6E5', // transparent / ice-blue lens
                'day'          : '#F5C842', // yellow lens
                'night'        : '#E84545', // red lens
            },
            spacing: {
              '3.75': '15px',
              '7.5' : '30px',
            ...
            animation: {
                ...
                'nova-marquee': 'nova-marquee 40s linear infinite',
            },
        },
    },
    corePlugins: {
